...
public class ForumUser {
    ...
    public void addComment(ForumPost thePost , String author, String commnetBody ){
        ForumComment theComment = new ForumComment(thePost,commnetBody,author);
        comments.add(theComment);

    }
    public int getPostsQuantity(){
        /// return 100 temprorary
        return posts.size();
    }
